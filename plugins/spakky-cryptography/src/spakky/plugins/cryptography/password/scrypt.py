...
Provides password hashing using the Scrypt key derivation function with
configurable CPU and memory cost parameters for resistance against hardware
brute-force attacks.
"""
...
from spakky.plugins.cryptography.error import PasswordRequiredError
...
class ScryptPasswordEncoder(IPasswordEncoder):
    ...
    Uses the Scrypt key derivation function for secure password hashing
    with configurable CPU/memory cost parameters for enhanced security.
    """
