...
> 인덱스 파일. SSOT는 `.claude/rules/python-code.md`, `.claude/rules/type-discipline.md`.
...
- `.claude/rules/python-code.md` — Python 표준
- `.claude/rules/type-discipline.md` — 타입 의미 부호화
