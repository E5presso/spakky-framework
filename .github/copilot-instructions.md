...
6.  **Global Documentation Synchronization**: Any changes to the codebase (APIs, configuration, behavior) MUST be immediately reflected in all relevant Markdown files (README.md, CHANGELOG.md, etc.) across the repository.
