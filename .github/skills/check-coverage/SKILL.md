---
name: check-coverage
description: Check test coverage for a Spakky Framework package. Use this skill when asked to check, measure, or view coverage for any package.
---
...
> **관련 스킬**: 커버리지 개선이 필요하면 → [improve-coverage](../improve-coverage/SKILL.md)
...
# 예시
uv run python scripts/run_coverage.py --package spakky-task
...
| `runTests` 도구의 `mode="coverage"` | 커버리지 XML 미생성      |
