...
- **scope**: `core`, `domain`, `data`, `event`, `task`, `actuator`, `cache`, `tracing`, `outbox`, `saga`, `fastapi`, `kafka`, `rabbitmq`, `redis`, `security`, `sqlalchemy`, `typer`, `celery`, `logging`, `opentelemetry`, `grpc`
