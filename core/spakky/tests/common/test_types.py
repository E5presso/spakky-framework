...
def test_is_optional() -> None:
    ...
    assert is_optional(Optional[str]) is True  # noqa: UP045 - legacy typing input contract
    assert is_optional(str) is False

    assert is_optional(str | int | None) is True
    assert is_optional(Optional[str | int]) is True  # noqa: UP045 - legacy typing input contract
    assert is_optional(Union[str, int]) is False  # noqa: UP007 - legacy typing input contract
...
def test_remove_none() -> None:
    ...
    assert remove_none(Optional[str]) is str  # noqa: UP045 - legacy typing input contract
    assert remove_none(str | int | None) == Union[str, int]  # noqa: UP007 - legacy typing output contract
...
def test_remove_none_with_union_of_none() -> None:
    ...
    result = remove_none(Union[int, str, None])  # noqa: UP007 - legacy typing input contract
    # Union comparison needs ==, not is
    assert result == Union[int, str]  # noqa: E721, UP007 - legacy typing output contract

    # Test Union[int, None] -> int
    result = remove_none(Union[int, None])  # noqa: UP007 - legacy typing input contract
