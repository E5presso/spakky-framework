...
| 규칙 파일 | 적용 대상 |
|-----------|----------|
| `.agents/rules/python-code.md` | `**/*.py` |
| `.agents/rules/test-writing.md` | `**/tests/**/*.py` |
| `.agents/rules/domain.md` | `**/domain/**/*.py` |
| `.agents/rules/aspect.md` | `**/aspects/**/*.py` |
| `.agents/rules/plugin.md` | `plugins/**/*.py` |
| `.agents/rules/monorepo.md` | 패키지 간 의존 방향 |
...
- `from typing import override` (version guard 없이) → 유효
