...
| 규칙 파일 | 적용 대상 |
|-----------|----------|
| `.agents/harness/rules/python-code.md` | `**/*.py` |
| `.agents/harness/rules/test-writing.md` | `**/tests/**/*.py` |
| `.agents/harness/rules/domain.md` | `**/domain/**/*.py` |
| `.agents/harness/rules/aspect.md` | `**/aspects/**/*.py` |
| `.agents/harness/rules/plugin.md` | `plugins/**/*.py` |
| `.agents/harness/rules/monorepo.md` | 패키지 간 의존 방향 |
