...
> 인덱스 파일. 실제 규칙은 `.agents/harness/rules/monorepo.md`, `.agents/harness/rules/domain.md`, `.agents/harness/rules/aspect.md`가 SSOT.
...
- `.agents/harness/rules/monorepo.md` — 패키지별 의존 방향
- `.agents/harness/rules/domain.md` — Aggregate 경계, Port 정의
- `.agents/harness/rules/aspect.md` — Aspect 동기/비동기 쌍 규칙
