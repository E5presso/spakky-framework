...
| Text와 image/audio/video/file input을 Agent에 안전하게 전달하기 | [AI Agent 개발](guides/agents.md), [LLM 모델 라우팅](guides/llm-routing.md), [AG-UI](guides/agent-ag-ui.md), [A2A](guides/agent-a2a.md) |
| Explicit fallback, retry/circuit와 complete-response cache 운영하기 | [LLM 모델 라우팅](guides/llm-routing.md), [spakky-llm API](api/plugins/spakky-llm.md) |
